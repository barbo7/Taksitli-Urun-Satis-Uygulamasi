...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
        ...
        *<br />
        ...
        <br />
        <asp:TextBox ID="TextBox3" TextMode="Number" runat="server" AutoPostBack="true" OnTextChanged="TextBox3_TextChanged"></asp:TextBox>
        <br />
        ...
        <br />
        <asp:TextBox ID="TextBox4" runat="server" TextMode="Number" AutoPostBack="true" OnTextChanged="TextBox4_TextChanged"></asp:TextBox>
        <br />
        <asp:Label ID="Label7" runat="server" Text="Aylık Ödenecek Miktar"></asp:Label>
        <br />
        <asp:TextBox ID="TextBox5" runat="server"  TextMode="Number" AutoPostBack="true" Enabled="False" Width="128px"></asp:TextBox>
        <br />
        <asp:Label ID="Label8" runat="server" Text="Müşteri Notu"></asp:Label>
        <br />
        <asp:TextBox ID="TextBox6" runat="server" Height="67px" Width="184px" ></asp:TextBox>
        <br />
        &nbsp;&nbsp;
